"""
Training script with F1 reward
...
TRAIN_JSONL = "/home/jiyoon/data/jsonl/training_data/shape3/all_looks.jsonl"  # {"image","solution","prompt"}
OUTPUT_DIR = "/home/jiyoon/data/ckpts/shape3/Qwen2.5-VL-7B-Instruct-v1-run0"
VAL_RATIO = 0.05
SEED = 42

WANDB_NAME = "qwen2.5-vl-7B-v1-run0"

COMPLETIONS_BASE = "/home/jiyoon/data/jsonl/completions/shape3"
VERSION = "v1"
RUN = "run1"
ROTATE = 500
...
def main():
    ...
    acc_reward = AccuracyReward_(reference_key="solution")

    L_F, L_A = 0.3, 1.0
    reward_fns = [
        weighted_(fmt_reward, L_F),
        weighted_(acc_reward, L_A),
    ]
