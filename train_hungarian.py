"""
Training script with reward defined using the Hungarian matrix
...
OUTPUT_DIR = "/home/jiyoon/data/ckpts/shape3/Qwen2.5-VL-7B-Instruct-v0-run1"
VAL_RATIO = 0.05
SEED = 42

WANDB_NAME = "qwen2.5-vl-7B-v0-run1"
